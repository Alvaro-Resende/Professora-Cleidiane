...
export function Marco() {
  return (
    <div className="flex px-10 py-10 justify-center items-center gap-3 flex-wrap">
      <div className="w-[300px] h-[130px] p-3 border-2 border-black rounded-md">
        <span
          className={`${lusitana.className} flex justify-center items-center text-xl font-bold gap-2`}
        >
          <BiSolidBookHeart className="text-3xl" /> 25+ anos de ensino
        </span>
      ...
      <div className="w-[300px] h-[130px] p-3 border-2 border-black rounded-md">
        <span
          className={`${lusitana.className} flex justify-center items-center text-xl font-bold gap-2`}
        >
          <FaGraduationCap className="text-3xl" /> Formada em Letras/Inglês
        </span>
      ...
      <div className="w-[300px] h-[130px] p-3 border-2 border-black rounded-md">
        <span
          className={`${lusitana.className} flex justify-center items-center text-xl font-bold gap-2`}
        >
          <FaGlobeAmericas className="text-3xl" /> Experiência Internacional
        </span>
      ...
      <div className="w-[300px] h-[130px] p-3 border-2 border-black rounded-md">
        ...
        >
          <FaUserGraduate className="text-3xl" /> Centenas de alunos formados
        </span>
